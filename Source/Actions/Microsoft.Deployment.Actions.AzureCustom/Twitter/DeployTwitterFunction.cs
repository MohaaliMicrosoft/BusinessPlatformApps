...
namespace Microsoft.Deployment.Actions.AzureCustom.Twitter
{
    ...
    public class DeployTwitterFunction : BaseAction
    {
        public override async Task<ActionResponse> ExecuteActionAsync(ActionRequest request)
        {
            ...
            var armTemplate = JsonUtility.GetJObjectFromJsonString(System.IO.File.ReadAllText( Path.Combine(request.ControllerModel.AppPath, "Service/AzureArm/function.json")));
